...
export anchorSourceDir="lan_socat_forwarder"
export anchorSource="lan_socat_forwarder.sh"
...
SET "MSWanchorSourceDir=lan_socat_forwarder"

SET "MSWanchorSource=lan_socat_forwarder.sh"
