...
For some reason, 'git pull' is succeeding inappropriately, causing the 'ubiquitous_bash.sh' script to not pupulate the '/home/root/.ubcore/ubiquitous_bash' directory with 'ubiquitous_bash.sh' during '_setupUbiquitous' after the '_local/ubcp/ubcp-cygwin-portable-installer.cmd' batch script is called by the 'build_ubcp' job of the 'build.yml' GitHub Actions YAML script.

Before the '_override_msw_git' function was added to prioritize native MSW git binaries over the Cygwin '/usr/bin/git', the 'git pull' command appropriately failed, and the 'ubiquitous_bash.sh' script correctly proceeded to populate the '/home/root/.ubcore/ubiquitous_bash' directory.

Please explain why this and related changes cause 'git pull' command to succeed inappropriately, behaving seemingly as if a '.git' subdirectory existed in the '/home/root/.ubcore/ubiquitous_bash' directory. If a '.git' subdirectory does somehow now exist in the '/home/root/.ubcore/ubiquitous_bash' directory, explain where that originated from to cause 'git pull' to succeed inappropriately. If a 'git' subdirectory should not exist in the '/home/root/.ubcore/ubiquitous_bash', explain how 'git pull' nevertheless succeeds inappropriately.


```output
Run .\_setupUbiquitous | tee /_setupUbiquitous.log
 init: setupUbiquitous 
detected: cygwin
 _setupUbiquitous_accessories-git 
 init: _setup_ubiquitousBash_cygwin 
 done: _setup_ubiquitousBash_cygwin: lean 
 ubHome= /home/root 
 ubcoreDir= /home/root/.ubcore 
 ubcoreFile= /home/root/.ubcore/.ubcorerc 
 ubcoreUBdir= /home/root/.ubcore/ubiquitous_bash 
 ubcoreUBfile= /home/root/.ubcore/ubiquitous_bash/ubiquitous_bash.sh 
 install: setupUbiquitous 
 attempt: git pull 
 init: _gitBest_detect_github_procedure 
 performance: export current_gitBest_source_GitHub=$("/cygdrive/c/a/ubiquitous_bash/ubiquitous_bash/ubiquitous_bash.sh" _gitBest_detect_github_sequence | tail -n1) 
Pseudo-terminal will not be allocated because stdin is not a terminal.
Warning: Permanently added 'github.com' (ED25519) to the list of known hosts.
git@github.com: Permission denied (publickey).
 current_gitBest_source_GitHub= github_https 
github_https
 init: _gitBest 
 current_gitBest_source_GitHub= github_https 
github_https
 init: _gitBest_sequence 
 current_gitBest_source_GitHub= github_https 
 HOME= /cygdrive/c/a/ubiquitous_bash/ubiquitous_bash/w_jVykkWYGTJBxK3tzt9/special_fakeHome 
 init: _gitBest_override_github 
...
[url "https://github.com/"]
 ...
 init: git 
From https://github.com/mirage335-colossus/ubiquitous_bash
 * [new tag]         build-14418685744-9999 -> build-14418685744-9999
Already up to date.
 pass: git pull 
 missing: ubcoreUBfile= /home/root/.ubcore/ubiquitous_bash/ubiquitous_bash.sh 
 FAIL 
```
